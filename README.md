...
- 십성·신살·12운성·형충회합은 체크박스만 제공하며, 계산 로직은 아직 구현되지 않았습니다(추후 지원 예정).
...
- **십성·신살·12운성·형충회합 미구현**: 화면에 체크박스만 있고 실제 계산 로직은 없습니다.
- **사주 해석 없음**: 간지·오행 통계 계산까지만 제공하며, 용신·격국 등 해석은 범위 밖입니다.
